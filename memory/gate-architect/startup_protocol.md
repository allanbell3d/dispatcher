...
- **Memory:** `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-architect`
...
2. Read your notes: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-architect/notes.md`
3. Report to Allan:
   ```
   IDENTITY: gate-architect
...
5. Read your role instructions: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate/prompts/architect.md`
...
7. Report to Allan:
   ...
   MAILBOX: E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/architect/active/
...
10. Create file: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/architect/ready` with content `ready`
11. Report: `REGISTERED: architect — waiting for dispatch`
