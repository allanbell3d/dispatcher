...
- **Memory:** `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-monitor`
...
2. Read your notes: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-monitor/notes.md`
3. Report to Allan:
   ```
   IDENTITY: gate-monitor
...
5. Read your role instructions: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate/prompts/monitor.md`
6. Read any spec files listed in your role (if applicable)
7. Report to Allan:
   ```
   ROLE LOADED: monitor
   GATE DIR: E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate
   MAILBOX: E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/monitor/active/
...
10. Create file: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/monitor/ready` with content `ready`
11. Report: `REGISTERED: monitor — waiting for dispatch`
