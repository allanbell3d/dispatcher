...
- **Memory:** `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-playwright`
...
2. Read your notes: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-playwright/notes.md`
3. Report to Allan:
   ```
   IDENTITY: gate-playwright
...
5. Read your role instructions: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate/prompts/playwright.md`
6. Read any spec files listed in your role (if applicable)
7. Report to Allan:
   ```
   ROLE LOADED: playwright
   GATE DIR: E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate
   MAILBOX: E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/playwright/active/
...
10. Create file: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/playwright/ready` with content `ready`
11. Report: `REGISTERED: playwright — waiting for dispatch`
