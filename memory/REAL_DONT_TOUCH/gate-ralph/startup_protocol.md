...
- **Memory:** `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-ralph`
...
2. Read your notes: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/memory/gate-ralph/notes.md`
3. Report to Allan:
   ```
   IDENTITY: gate-ralph
...
5. Read your role instructions: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate/prompts/ralph.md`
6. Read any spec files listed in your role (if applicable)
7. Report to Allan:
   ```
   ROLE LOADED: ralph
   GATE DIR: E:/Business/Real Estate/Villa number 2 -60-62/Advert/gate
   MAILBOX: E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/ralph/active/
...
10. Create file: `E:/Business/Real Estate/Villa number 2 -60-62/Advert/dispatch/ralph/ready` with content `ready`
11. Report: `REGISTERED: ralph — waiting for dispatch`
