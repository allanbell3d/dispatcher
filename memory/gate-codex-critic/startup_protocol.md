...
1. Read your notes: `D:/IA/dispatcher_repo/memory/gate-codex-critic/notes.md`
2. Report to Allan:
   ```text
   IDENTITY: gate-codex-critic
...
4. Read your role instructions: `D:/IA/dispatcher_repo/agents/profiles/coordinated/gate-codex-critic/role_prompt.md`
5. Read any spec files listed in your role, if applicable.
6. Report to Allan:
   ```text
   ROLE LOADED: critic
   GATE DIR: D:/IA/dispatcher_repo/dispatch/gate-codex-critic
   MAILBOX: D:/IA/dispatcher_repo/dispatch/gate-codex-critic/inbox/
...
9. Create file: `D:/IA/dispatcher_repo/dispatch/gate-codex-critic/ready` with content `ready`
10. Report: `REGISTERED: critic - waiting for dispatch`
